        ...
        <div class="col-md-8">
            <div class="card">
                ...
                {{ Form::model(request()->all(),['route' => 'laboratories.reports.index', 'method'=>'get']) }}
                        ...
                        {{Form::date('start', null, ['required', 'class' => 'form-control']) }}

                    <br>
                        {{Form::label('end', 'fecha fin') }}
                        {{Form::date('end', null, ['required', 'class' => 'form-control']) }}

                    <br>
                        {{Form::label('laboratory_id', 'laboratorio') }}
                        {{Form::select('laboratory_id', $laboratories,null,['placeholder'=>'Todos', 'class' => 'form-control']) }}
